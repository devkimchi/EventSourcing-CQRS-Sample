...
{
    /// <summary>
    /// This represents the mapper entity for <see cref="UserCreatedEvent" /> to <see cref="EventStream" />.
    /// </summary>
    public class UserCreatedEventToEventStreamMapper : BaseEventToEventStreamMapper<UserCreatedEvent>
    {
        /// <summary>
        ...
        protected override void Initialise()
        {
            ...
            Mapper.CreateMap<UserCreatedEvent, EventStream>()
